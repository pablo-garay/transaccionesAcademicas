...
class FuncionesDB {
	/*getDatosUsuario retorna datos del usuario*/
	public function getDatosUsuario (AdapterInterface $dbadapter, $usuario){
	...
	public function getMateriasYProfesoresUsuario(AdapterInterface $sapDbAdapter, $numeroDocumento, $actual){
